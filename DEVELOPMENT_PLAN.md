...
| 审核系统 | 教师审核批改、评分、反馈 | ✅ `review-submission` 云函数、教师审核页真实数据、审核弹层、反馈图片/附件与积分发放已完成 |
| 积分系统 | 积分累计、积分消费、积分排行 | 🟡 审核发放、累计积分与学生排行已接通，积分消费、积分明细与抽奖待开发 |
| 抽奖系统 | 积分抽奖、奖品管理 | ⬜ 待开发 |
| 排行榜 | 学生积分排行、任务完成排行 | 🟡 学生周榜/月榜/总榜真实数据与 `get-ranking` 云函数已完成，班级榜与更多统计待开发 |
...
**最后更新**: 2026-04-10
**编写者**: 开发团队
**更新说明**: 同步首页真实数据、学生排行榜接入、`get-ranking` 云函数、登录协议确认与最新服务层结构
