...
export const TASK_DIFFICULTY_TEXT = {
...
export const CLASS_MEMBER_ROLE = {
  MEMBER: 'member',
  ADMIN: 'admin'
} as const;
...
export const DRAW_RECORD_STATUS = {
  DRAWN: 'drawn',
  CLAIMED: 'claimed',
  EXPIRED: 'expired'
} as const;
...
export const DEFAULT_PAGE_SIZE = PAGE_SIZE.MEDIUM;

// ========== 图片相关 ==========
export const IMAGE_MAX_SIZE = 10 * 1024 * 1024; // 10MB

export const IMAGE_MAX_COUNT = {
  TASK: 9,
  SUBMISSION: 9,
  AVATAR: 1
};
