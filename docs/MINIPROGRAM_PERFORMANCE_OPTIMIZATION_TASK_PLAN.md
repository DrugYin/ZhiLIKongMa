...
| 公告平均耗时 | 671～794ms | 未实施 | ≤400ms | 未验收 |
| 学生聚合接口平均耗时 | 无 | 未实施 | ≤500ms | 未验收 |
| 教师聚合接口平均耗时 | 无 | 未实施 | ≤500ms | 未验收 |
| 审核聚合接口平均耗时 | 无 | 未实施 | ≤600ms | 未验收 |
| 主包体积 | 待开发者工具确认 | 未实施 | ≤1.5MiB | 未验收 |
| 学生首页 P75 | 待真机测量 | 未实施 | ≤1.5s | 未验收 |
| 教师首页 P75 | 待真机测量 | 未实施 | ≤1.8s | 未验收 |
| 审核中心 P75 | 待真机测量 | 未实施 | ≤1.5s | 未验收 |
| 云函数错误/超时/限流 | 0/0/0 | 未实施 | 0/0/0 | 未验收 |
